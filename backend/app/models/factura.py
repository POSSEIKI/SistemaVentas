...
class Factura(Base):
    ...
    domicilio_direccion = Column(String(300), nullable=True)
    domicilio_telefono = Column(String(50), nullable=True)
    domicilio_notas = Column(Text, nullable=True)
    domicilio_distancia_km = Column(Numeric(6, 2), nullable=True)
